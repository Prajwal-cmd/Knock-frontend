...
const FileMenu = ({anchorE1,chatId}) => {
  ...
  const fileChangeHandler =async (e,key)=>{
    ...
    if( files.length >5) return  toast.error(`You can send upto 5 ${key} only`)
    ...
    try {
      ...
      if(res.data) toast.success(`Sent`,{id:toastId})
      else toast.error("Retry",{id:toastId})
    } catch (error) {
    ...
    <Menu  open={isFileMenu} anchorEl={anchorE1} onClose={closeFileMenu}>
        ...
        <MenuList>
          ...
          <MenuItem onClick={selectVideo}>
            ...
            <input type='file' multiple accept='video/mp4 ,video/ogg, video/webm ' style={{display:"none"}}
